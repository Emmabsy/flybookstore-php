<?php
	...
	<table class="table">
		...
		<tr>
			...
			<td><?php echo "KES" . $book['book_price']; ?></td>
			<td><?php echo $qty; ?></td>
			<td><?php echo "KES" . $qty * $book['book_price']; ?></td>
		</tr>
		<?php } ?>
		<tr>
			<th>&nbsp;</th>
			...
			<th><?php echo "KES" . $_SESSION['total_price']; ?></th>
		</tr>
		<tr>
			<td>Shipping</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th><?php echo "KES" . ($_SESSION['total_price'] + 20); ?></th>
		</tr>
	</table>
	<br>
	<br>
	<h4 class= "text-center"style="margin-left:-20px ">Your Information</h4>
	<br>
    ...
    <div class="form-group col-md-12" >
        <div class="form-group" >
            <div class="col-lg-10 col-lg-offset-2" style="margin-left:0px">
                <a href="checkout.php" type="reset" class="btn btn-default">Cancel</a>
        ...
        <br>
        <br>
	<p class="lead">Press Purchase to confirm your purchase, or Cancel  to reset the form .</p>
	<br>
	<br>
	<br>
<?php
