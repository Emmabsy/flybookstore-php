...
<h3 class="text-center text-muted"> In Our Store Now!!! </h3>
<p class=" text-muted "> Sort Books by:</p> 
...
<form method="post" action="books.php">
  ...
  <button type="submit" class="btn btn-primary" name="price">Price</button>
  <button type="submit" class="btn btn-primary" name="author">Author</button>
  <button type="submit" class="btn btn-primary btn-md" name="title">Title</button>
          ...
          <div class="col-md-3">
            <a href="book.php?bookisbn=<?php echo $query_row['book_isbn']; ?>">
              ...
              <table>
                ...
                <tr>
                <td><strong>KES <?php echo $query_row['book_price'];?></strong>  </td>
                </tr>
              </table>
            </div>
        <?php
